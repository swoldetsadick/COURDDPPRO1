...
shinyUI(pageWithSidebar(
        ...
        mainPanel(
                ...
                h6('Observe how as you raise the number of observations in samples, or number of iteration the density of said distribution closely tends to its corresponding central limit theorem normal distribution.'),
                h6('Expected value of these averages approaches that of the real value of the mean of the distribution from which these observations are sampled of.'),
