...
shinyUI(pageWithSidebar(
        ...
        mainPanel(
                ...
                h6('Observe how as you raise the number of observations in samples, or number of iteration the density of said distribution closes to the density of its corresponding central limit theorem normal distribution, drawn in full blueline here.'),
                h6('Expected value of these averages approaches, also shown in graph by a vertical dashed red line, that of the real value of the mean of the distribution from which these observations are sampled of.'),
